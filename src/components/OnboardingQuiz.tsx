...
function AuthModal({
  ...
  async function handleGoogleSignIn() {
    ...
    setAuthError("");
    // Save swipes so the OAuth redirect callback (onAuthStateChange SIGNED_IN) can restore them
        ...
        <div className="px-6 py-5 space-y-3">
          ...
          {!magicSent ? (
            ...
            >
              ...
              <p className="text-sm font-semibold text-foreground">Check your email for your magic link!</p>
