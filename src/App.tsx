  ...
  return (
    <div className="h-screen w-full bg-background flex flex-row overflow-hidden fixed inset-0">
      <main className="flex-1 flex flex-col min-w-0 h-full relative overflow-hidden">
        {/* Header - Restored to full size and fixed for all devices */}
        <header className="h-16 px-4 md:px-6 border-b border-border flex items-center justify-between bg-background z-50 shrink-0">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button 
              onClick={() => user ? signOut() : setAuthOpen(true)}
              className="md:hidden w-10 h-10 rounded-full bg-card border flex items-center justify-center shadow-sm active:bg-accent"
            >
            ...
            <button 
              ...
              className="md:hidden relative w-10 h-10 rounded-full bg-card border flex items-center justify-center shadow-sm active:bg-accent"
            >
            ...
            <div ref={sortBtnRef} className="relative">
              <button onClick={() => setSortOpen(!sortOpen)} className="w-10 h-10 rounded-full border flex items-center justify-center hover:bg-accent transition-colors">
        ...
        {/* Main Content Area - Fixed height flex container to prevent overlap */}
        <div className="flex-1 flex flex-col items-center justify-between p-4 md:p-6 min-h-0 overflow-hidden">
