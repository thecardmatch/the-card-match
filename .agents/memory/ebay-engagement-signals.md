...
**How to apply:** Any feed mapper or engagement enrichment must carry an availability signal into recommendation scoring and keep the same behavior in local Express and production Cloudflare runtimes.